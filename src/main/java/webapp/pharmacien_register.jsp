                                ...
                                <div class="register-form form-item ">
                                    <form class="form-stl" action="PharmacienRegisterServlet" name="frm-login" method="post" >
                                        <fieldset class="wrap-title">
                                            ...
                                            <h4 class="form-subtitle">Informations de pharmacien</h4>
                                        </fieldset>									
                                        ...
                                        <fieldset class="wrap-input">
                                            <label for="frm-reg-email">Tel</label>
                                            <input type="text" id="frm-reg-phone" name="tel" placeholder="Telephone" value="<%=  (request.getParameter("tel") != null && !request.getParameter("tel").isEmpty()) ? request.getParameter("tel"): "" %>">
                                        </fieldset>
                                        ...
                                        <div>
                                            <a href="pharmacie_register.jsp" type="submit" class="link-term mercado-item-title" class="btn btn-sign" value="Suivant" name="Suivant">Suivant</a>
                                        </div> 
                                    </form>
